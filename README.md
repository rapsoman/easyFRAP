...
_EasyFRAP-web_: EasyFRAP became web-based! Visit EasyFRAP web here: https://easyfrap.vmnet.upatras.gr/

_Stochastic modeling of FRAP experiments_: For inference of kinetic parameters from FRAP data (diffusion coefficient, bound fraction and residence time) see:
